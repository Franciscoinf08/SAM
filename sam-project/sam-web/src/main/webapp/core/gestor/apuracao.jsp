...
<%
    ...
    ProgramaFidelidadeService manterProgramaFidelidade = new ProgramaFidelidadeService();
    ...
    <section class="tabela-container">
        ...
        <table>
            ...
            <tr>
                ...
                <td><%= manterProgramaFidelidade.buscarProgramaFidelidade(transacao.getIdProgramaFidelidade().intValue()).getNome() %></td>
